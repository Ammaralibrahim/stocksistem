...
export default function DrugsPage() {
  ...
  const fetchDrugs = useCallback(async () => {
    ...
    try {
      ...
      if (filter === 'low-stock') {
        params.minStock = 0
        params.maxStock = 10 // or use lowStockThreshold, but we'll keep simple
      } else if (filter === 'expiring') {
        // Not directly supported by API, we'll filter client-side
      }
      if (categoryFilter) {
  ...
  // Client-side filtering for expiring soon (30 days)
                ...
                >
                  ...
                  <div className="grid grid-cols-3 gap-1 mt-2 text-[10px]">
                    ...
                    <div>
                      ...
                      <span className="mr-1 font-medium">{drug.price} ل.س</span>
                    </div>
                    <div>
